...
#'
#' Learns a heterogeneous sample mixture model of the form x = Bw,
#'  where x is a p-by-1 column vector representing the sample,
#'  B is a p-by-m matrix of m basis vectors and w is a m-by-1 vector of
#'  mixture coefficients. The model is subject to several constraints, which
#'  are outlined below.
#'
...
#'  w_m is known, and we must learn w_i for i = 1, ..., (m-1)
#'
...
#' }
consNMF <- function( x, Bm1, wm, nIter=1000 )
{
